...
public class OverLoadingExmaple {
	...
	public static void main(String[] args) {
		...
		OverLoadingExmaple instance=new OverLoadingExmaple();
		...
		//Object argument method will call, if Object argument method not found then it will throw the error
		instance.method(new Object());

		//String argument method will call 
		//If String argument method not found then it will look for Object argument method
		//If Object argument method not found then it will throw the error
		instance.method("String");

		//Integer argument method will call 
		//If Integer argument method not found then it will look for Object argument method
		...
		//If int argument method not found then it will look for Integer argument method
		//If Integer argument method not found then it will look for Object argument method
		//If Object argument method not found then it will throw the error
		int intValue=10;
